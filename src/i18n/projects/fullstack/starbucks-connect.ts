export const starbucksConnectEN = {
  slug: "starbucks-connect",
  category: "Full Stack",
  name: "Starbucks Connect",
  summary: "Café social connection platform — Angular frontend, ASP.NET Core backend, Clean Architecture, SQL Server.",
  year: "2024",
...
export const starbucksConnectAR = {
  ...
  category: "Full Stack",
  name: "Starbucks Connect",
  summary: "منصة اتصال اجتماعي للكافيه — واجهة أمامية Angular، خلفية ASP.NET Core، Clean Architecture، SQL Server.",
  year: "٢٠٢٤",
