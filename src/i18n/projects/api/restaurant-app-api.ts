export const restaurantAppApiEN = {
...
export const restaurantAppApiAR = {
  slug: "restaurant-app-api",
  category: "REST API",
  name: "Restaurant App API",
  summary: "واجهة إدارة المطعم REST على ASP.NET Core وClean Architecture وSQL Server وSwagger.",
  year: "٢٠٢٤",
  role: "مهندس Backend",
