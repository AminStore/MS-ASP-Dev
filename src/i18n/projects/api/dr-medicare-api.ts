...
export const drMedicareApiAR = {
  slug: "dr-medicare-api",
  category: "REST API",
  name: "Dr MediCare API",
  summary: "واجهة حجز المواعيد الطبية REST على ASP.NET Core وClean Architecture وSQL Server وSwagger.",
  year: "٢٠٢٤",
  role: "مهندس Backend",
